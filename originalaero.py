...
#         mask2 = x >= p
#         yc[mask2] = m/(1-p)**2 * ((1-2*p) + 2*p*x[mask2] - x[2]**2)
#         dyc_dx[mask2] = 2*m/(1-p)**2 * (p - x[2]) # Corrected indexing here
# 
#     # Surface coordinates
#     theta = np.arctan(dyc_dx)
#     xu = x - yt*np.sin(theta)
...
#         ax3.legend()
# 
#     plt.colorbar(strm.lines, ax=ax3, label='Flow Speed')
# 
#     # Actuator effectiveness
#     if actuators:
#         act_names = [f"{a['type'][0].upper()}{i+1}" for i, a in enumerate(actuators)]
...
# 
#                         if st.button("Update Actuator"):
#                             st.session_state.actuator_placement.update_actuator(
#                                 st.session_state.actuators[selected_actuator],
#                                 new_x, new_strength,
#                                 st.session_state.x, st.session_state.y
#                             )
#                             # Recalculate effectiveness
...
# 
# 
# # Helper function for ActuatorPlacement to update actuator y-coordinate
# def update_actuator_y_coordinate(actuator, x_new, x_coords, y_coords):
#     actuator['x'] = x_new
#     actuator['y'] = np.interp(x_new, x_coords, y_coords)
# 
# # Adding update_actuator method to SmartActuatorPlacement class
# # This makes it easier to modify actuator properties directly.
# SmartActuatorPlacement.update_actuator = update_actuator_y_coordinate
# 
# 
